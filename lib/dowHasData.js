...
var debug = (0, _debug2.default)('djia:hasData');
...
var closedDates = {
  ...
  'YYYY-MM-DD': ['2015-05-25', '2015-07-03', '2015-09-07', '2015-11-26', '2015-12-25',
  // 2016
  '2016-01-18', '2016-02-15', '2016-03-25', '2016-05-30', '2016-07-04', '2016-09-05', '2016-11-24', '2016-12-26',
  // 2017
...
var dowHasData = function dowHasData(date, __now) {
  var mDate = (0, _momentTimezone2.default)(date);
  var dateFormat = mDate.format('YYYY-MM-DD');
  var open = marketOpen(mDate);
  var nowDow = (__now ? (0, _momentTimezone2.default)(__now) : (0, _momentTimezone2.default)()).tz('America/New_York');
  var dowFormat = nowDow.format('YYYY-MM-DD');
  var isBeforeDay = dateFormat < dowFormat;
  var isAfterDay = dateFormat > dowFormat;
  var isSameDay = dateFormat === dowFormat;
